    ...
    <div className={styles['container']}>
      ...
      <div className={styles['buttoncl']}>
        ...
        {showMore && (
          <span>
            {' '}
            (Quikr India Pvt. Ltd.) and its business associates, partners and/or affiliates to call, sms or email me in connection with my application
            or for offering other products and services and I agree to the
            <span
              onClick={() => {
                setShowMore(false);
              }}>
